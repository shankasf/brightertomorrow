...
NO_CLINICIAN_FROM_MEMORY_RULE = (
    ...
    "(a) the [[THERAPIST_PICKER]] widget (simple pick-from-list) or the "
    "[[MATCH_QUIZ]] widget (needs-based matching) which the system renders, "
    "or (b) the explicit roster/match tool output present in the current "
    "context. If neither is present, do not name a clinician — instead "
    "ask which therapist they would like, offer the therapist picker, or "
    "offer the match quiz. "
