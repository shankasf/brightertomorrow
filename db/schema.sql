...
CREATE TABLE IF NOT EXISTS site_settings (
  ...
  primary_phone   TEXT,
  primary_email   TEXT,
  primary_color   TEXT NOT NULL DEFAULT '#E1B878',
  text_color      TEXT NOT NULL DEFAULT '#192735',
  muted_color     TEXT NOT NULL DEFAULT '#858585',
  surface_color   TEXT NOT NULL DEFAULT '#F2F2F2',
  logo_url        TEXT,
  hero_image_url  TEXT,
