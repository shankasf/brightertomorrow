...
const IMPACT_CATEGORIES = [
  {
    ...
    body: "Adults with untreated ADHD are more likely to experience underemployment, frequent job changes, and difficulty reaching their professional potential despite high intelligence and capability.",
  },
  {
    title: "Relationships & Family",
    body: "Partners and family members often feel unheard, forgotten, or deprioritized. Children with ADHD may struggle to form and maintain friendships, leading to social isolation and loneliness.",
  },
  {
    title: "Mental & Emotional Health",
    body: "ADHD rarely travels alone. Anxiety, depression, low self-worth, and burnout are common co-occurring conditions, especially in people who spent years masking or compensating without support.",
  },
];
...
const SIGNS = {
  children: [
    ...
    { Icon: FiHeart, title: "Social Challenges", body: "Trouble engaging quietly in leisure activities, preferring constant stimulation, struggling with structured or turn-taking games." },
  ],
  teens: [
    { Icon: FiPenTool, title: "Poor Organization", body: "Missed deadlines, lost assignments, disorganized backpack or workspace, difficulty managing school workload independently." },
    { Icon: FiClock, title: "Hyperfocus on Screens", body: "Hours lost to games, social media, or videos while struggling to focus on schoolwork for even short periods." },
    { Icon: FiAlertCircle, title: "Risk-Taking Behavior", body: "Increased likelihood of impulsive decisions, experimentation with substances, or engaging in unsafe situations." },
    { Icon: FiClock, title: "Sleep Disruption", body: "Racing thoughts at bedtime, difficulty winding down, inconsistent sleep schedules that affect morning functioning." },
    { Icon: FiUsers, title: "Social Difficulties", body: "Impulsive comments that damage friendships, interrupting peers, difficulty reading social cues, or isolation." },
    { Icon: FiBookOpen, title: "Declining Academic Performance", body: "Grades drop as academic demands increase and coping strategies from earlier years no longer work." },
  ],
  adults: [
    { Icon: FiPenTool, title: "Chronic Disorganization", body: "Persistent difficulty managing time, keeping track of tasks, maintaining an organized home or workspace." },
    { Icon: FiActivity, title: "Mental Fog", body: "Difficulty concentrating in meetings or conversations, forgetting what was just said, losing track of trains of thought." },
    { Icon: FiAlertCircle, title: "Overwhelm & Paralysis", body: "Too many competing demands leading to complete shutdown, avoidance, or procrastination on important responsibilities." },
    { Icon: FiBriefcase, title: "Workplace Challenges", body: "Starting tasks but not finishing them, missing deadlines, struggling to prioritize, frequent job changes." },
    { Icon: FiUsers, title: "Relationship Strain", body: "Forgetting important dates or commitments, emotional reactivity, difficulty being present during conversations." },
    { Icon: FiHeart, title: "Low Self-Esteem", body: "Years of feeling “less than,” shame around underachievement, and internalized beliefs of being lazy or stupid." },
  ],
} as const;

const TREATMENT = [
  { Icon: FiClipboard, title: "Comprehensive Assessment", body: "Understanding the full picture before recommending any path forward. We look at history, environment, co-occurring conditions, and individual strengths." },
  { Icon: FiActivity, title: "Behavioral Therapy", body: "Practical skill-building in areas like executive functioning, emotional regulation, time management, and organizational systems tailored to the individual." },
  { Icon: FiUsers, title: "Parent Coaching", body: "Equipping parents with strategies to support their child at home and advocate effectively within school environments." },
  { Icon: FiBookOpen, title: "Psychoeducation", body: "Teaching clients and families to understand how ADHD affects the brain, reducing shame and replacing it with self-awareness and self-compassion." },
  { Icon: FiUserCheck, title: "Collaborative Care Coordination", body: "We work alongside psychiatrists, schools, and pediatricians to ensure a cohesive support system around every client we serve." },
];

const FAQS = [
  {
    q: "Can ADHD be diagnosed in adults if they were never diagnosed as a child?",
    a: "Absolutely. Many adults, particularly women, receive their first ADHD diagnosis in their 30s, 40s, or even later. Symptoms were often present in childhood but went unrecognized or were masked by high intelligence or compensatory strategies.",
  },
  {
    q: "Does ADHD always require medication?",
    a: "Not always. Medication can be helpful for many people, but it is one tool among many. Our clinicians take a holistic view and work with each client to determine what combination of supports will be most effective for their unique situation.",
  },
  {
    q: "How is ADHD diagnosed?",
    a: "Diagnosis typically involves a thorough clinical interview, standardized rating scales, review of developmental and educational history, and sometimes direct observation. It is a process, not a single test.",
  },
  {
    q: "Is my child's ADHD caused by too much screen time or sugar?",
    a: "No. ADHD is a neurodevelopmental condition with strong genetic roots. While diet and screens can influence behavior, they do not cause ADHD. This is a well-established finding in the research literature.",
  },
  {
    q: "Will my child outgrow ADHD?",
    a: "ADHD does not simply disappear, though it often changes with age. Some symptoms become less obvious in adulthood while others remain. Building strong coping skills and self-awareness during childhood creates a strong foundation for adult life.",
  },
  {
    q: "What if ADHD is not the only issue my child or I am dealing with?",
    a: "Co-occurring conditions are common. Anxiety, depression, learning differences, and trauma frequently appear alongside ADHD. Our clinicians are trained to hold the full picture and provide integrated care.",
  },
];
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <Reveal className="lg:col-span-7 order-1 lg:order-2">
              ...
              <p className="mt-6 text-[15px] sm:text-[16px] leading-[1.75] text-ink-soft">
                ...
                is not a discipline problem, a character flaw, or a result of
                poor parenting.
              </p>
        ...
        <div className="container-x">
          <Reveal>
            <h3 className="text-center font-display font-bold text-white text-[28px] sm:text-[34px] lg:text-[40px] leading-[1.15]">
              The Real-World <span style={{ color: GOLD }}>Impact</span> of Untreated ADHD
            </h3>
        ...
        <div className="container-x">
          <Reveal>
            <h3
              ...
              style={{ color: INK }}
            >
              ADHD Is <span style={{ color: WINE }}>Treatable.</span> Progress Is Possible.
            </h3>
      ...
      <section style={{ backgroundColor: WINE }} className="py-20 lg:py-24">
        <div className="container-x">
          <Reveal>
            ...
            <p className="mt-5 text-center text-white/85 text-[15px] sm:text-[16px] max-w-[820px] mx-auto leading-[1.7]">
              There is no single path to managing ADHD. Our clinicians work
              collaboratively with clients and families to build an
              individualized plan that draws from multiple modalities and fits
              real life.
            </p>
          </Reveal>
